...
*/
    ...
    public native byte[] doGetDieId();

    public native void doSetStandbyModeOff();

    public native void doSetStandbyModeOn();
   ...
   private void notifyResetNfc() {
       mListener.onFullReset();
   }
